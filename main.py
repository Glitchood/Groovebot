...
@client.event
async def on_ready():
  await client.change_presence(status=discord.Status.dnd, activity=discord.Activity(type = discord.ActivityType.watching, name='/help'))
...
async def help(interaction: discord.Interaction, commands: discord.app_commands.Choice[int]=0):
  ...
  em.set_footer(text="Generated by Groovebot",
  ...
  if commands == 0:
    ...
    if command == 'share':
      ...
      share_embed.set_author(name="Groovebot",
                       url="https://gg.gg/groovebot",
                       icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/musical-keyboard-microsoft.png")

      share_embed.add_field(name="**Parameters**",
                      ...
                      inline=False)
      share_embed.add_field(name="**Output Info**",
                      ...
                      inline=False)
      share_embed.set_footer(text="Generated by Groovebot",
                       icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/counterclockwise-arrows-button-microsoft.png")

      await interaction.followup.send(embed=share_embed)
      
    elif command == 'showtop':
      showtop_embed = discord.Embed(title="Info for `/showtop`",
        description="Show the top shared songs in the server!",
        colour=0x00b0f4,
        timestamp=dt.now())

      showtop_embed.set_author(name="Groovebot",
      url="https://gg.gg/groovebot",
      icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/musical-keyboard-microsoft.png")

      showtop_embed.add_field(name="**Parameters**",
      ...
      say_embed.set_author(name="Groovebot",
                       url="https://gg.gg/groovebot",
                       icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/musical-keyboard-microsoft.png")

      say_embed.add_field(name="**Parameters**",
                      value="```ansi\n\033[37;1m thing_to_say: \033[0m What the bot should say (Default = 'hi')\n```",
                      inline=False)
      say_embed.add_field(name="**Output Info**",
                      value="```ansi\n\033[37;1m Bot outputs the following:\n\033[0m <username> said '<thing_to_say>'\n```",
                      inline=False)

      say_embed.set_footer(text="Generated by Groovebot",
                       icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/counterclockwise-arrows-button-microsoft.png")
      ...
      ping_embed.set_author(name="Groovebot",
      url="https://gg.gg/groovebot",
      icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/musical-keyboard-microsoft.png")

      ping_embed.add_field(name="**Parameters**",
      value="```ansi\n\033[37;1m hidden: \033[0m Should the bot's response appear only to you? (Default = 'False')\n```",
      inline=False)
      ping_embed.add_field(name="**Output Info**",
      value="```ansi\n\033[37;1m Bot outputs the following:\n\033[0m Pong, @<user>!\n```",
      inline=False)

      ping_embed.set_footer(text="Generated by Groovebot",
      icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/counterclockwise-arrows-button-microsoft.png")
      ...
      help_embed.set_author(name="Groovebot",
      url="https://gg.gg/groovebot",
      icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/musical-keyboard-microsoft.png")

      help_embed.add_field(name="**Parameters**",
      value="```ansi\n\033[37;1m commands: \033[0m Commands to choose from\n```",
      inline=False)
      help_embed.add_field(name="**Output Info**",
      value="```ansi\n\033[37;1m Bot outputs information for each command\033[0m through Parameters and Output Info\n```",
      inline=False)

      help_embed.set_footer(text="Generated by Groovebot",
      icon_url="https://cdn-0.emojis.wiki/emoji-pics/microsoft/counterclockwise-arrows-button-microsoft.png")
      await interaction.followup.send(embed = help_embed)
      
    else: 
      await interaction.followup.send('idk what u did but u somehow messed this up :shrug:')
...
async def ping(interaction: discord.Interaction, hidden: discord.app_commands.Choice[int]=0):
  displayname = interaction.user.display_name
  username = interaction.user.name
  await cmd(interaction.command.name,username)
  if hidden == 0:
    await interaction.response.send_message(f"Pong, {interaction.user.mention}!", ephemeral=False)
